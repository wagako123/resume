  ...
  return (
    <div className='fixed w-full h-20 shadow-xl z-[100]'>
      <div className='flex justify-between items-center w-full h-full px-2 xl:px-16'>
        <Image src='/../public/assets/correctbg.png' alt='/' width='100' height='50'/>
        <div>
        ...
        <div className={nav ?'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500': 'fixed left-[-100%]  p-10 ease-in duration-500 '}>
          <div>
            <div className='flex w-full items-center justify-between'>
              <Image src='/../public/assets/correctbg.png' alt='/' width='150' height='80'/>
          ...
          <div className='py-4 flex flex-col'>
            ...
            <div className='pt-10'>
              <p className='uppercase tracking-widest text-gray-400' > lets connect</p>
